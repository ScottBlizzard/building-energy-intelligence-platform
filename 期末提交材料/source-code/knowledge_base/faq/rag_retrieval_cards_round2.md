...
**关键词：** `时间范围` `时间粒度` `3小时` `2026-03-01` `2026-06-01` `timestamp` `93天`
...
**关键词：** `异常` `abnormal` `equipment_status` `190条` `6.4%` `异常率` `R00001` `R02718`
...
- 共 190 条异常记录，占 6.4%
- 四栋建筑均匀分布
- 典型案例：R00001（教学楼凌晨高电耗）、R00024（图书馆低 COP=2.34）、R02718（实验楼全库最高电耗 639.11 kWh）
...
**关键词：** `能耗对比` `electricity_kwh` `建筑对比` `实验楼` `BLD-D` `381.3 kWh` `高功率设备`
...
**预期回答要点：**
- BLD-D 实验楼电耗最高，3h 均值 381.3 kWh，最高单次 639.1 kWh
- BLD-B 办公楼最低，均值 227.9 kWh
