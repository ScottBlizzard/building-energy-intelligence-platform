...
\midrule
\endhead
MC-01 & 任务分解 & 对“任务分解”设置明确检查方式，发现问题后由整合者修复或协调相关同学补齐。 & 检查清单、提交记录或最终文档。 \\
MC-02 & 成员边界 & 对“成员边界”设置明确检查方式，发现问题后由整合者修复或协调相关同学补齐。 & 检查清单、提交记录或最终文档。 \\
MC-03 & 第一次整合 & 对“第一次整合”设置明确检查方式，发现问题后由整合者修复或协调相关同学补齐。 & 检查清单、提交记录或最终文档。 \\
MC-04 & 第二次整合 & 对“第二次整合”设置明确检查方式，发现问题后由整合者修复或协调相关同学补齐。 & 检查清单、提交记录或最终文档。 \\
MC-05 & 最终优化 & 对“最终优化”设置明确检查方式，发现问题后由整合者修复或协调相关同学补齐。 & 检查清单、提交记录或最终文档。 \\
MC-06 & 接口控制 & 对“接口控制”设置明确检查方式，发现问题后由整合者修复或协调相关同学补齐。 & 检查清单、提交记录或最终文档。 \\
MC-07 & 数据控制 & 对“数据控制”设置明确检查方式，发现问题后由整合者修复或协调相关同学补齐。 & 检查清单、提交记录或最终文档。 \\
MC-08 & 代码审查 & 对“代码审查”设置明确检查方式，发现问题后由整合者修复或协调相关同学补齐。 & 检查清单、提交记录或最终文档。 \\
MC-09 & 测试闸门 & 对“测试闸门”设置明确检查方式，发现问题后由整合者修复或协调相关同学补齐。 & 检查清单、提交记录或最终文档。 \\
MC-10 & 文档闸门 & 对“文档闸门”设置明确检查方式，发现问题后由整合者修复或协调相关同学补齐。 & 检查清单、提交记录或最终文档。 \\
MC-11 & 安全闸门 & 对“安全闸门”设置明确检查方式，发现问题后由整合者修复或协调相关同学补齐。 & 检查清单、提交记录或最终文档。 \\
MC-12 & 提交闸门 & 对“提交闸门”设置明确检查方式，发现问题后由整合者修复或协调相关同学补齐。 & 检查清单、提交记录或最终文档。 \\
MC-13 & 风险跟踪 & 对“风险跟踪”设置明确检查方式，发现问题后由整合者修复或协调相关同学补齐。 & 检查清单、提交记录或最终文档。 \\
MC-14 & 变更记录 & 对“变更记录”设置明确检查方式，发现问题后由整合者修复或协调相关同学补齐。 & 检查清单、提交记录或最终文档。 \\
MC-15 & 沟通机制 & 对“沟通机制”设置明确检查方式，发现问题后由整合者修复或协调相关同学补齐。 & 检查清单、提交记录或最终文档。 \\
MC-16 & 质量目标 & 对“质量目标”设置明确检查方式，发现问题后由整合者修复或协调相关同学补齐。 & 检查清单、提交记录或最终文档。 \\
MC-17 & 配置管理 & 对“配置管理”设置明确检查方式，发现问题后由整合者修复或协调相关同学补齐。 & 检查清单、提交记录或最终文档。 \\
MC-18 & 版本管理 & 对“版本管理”设置明确检查方式，发现问题后由整合者修复或协调相关同学补齐。 & 检查清单、提交记录或最终文档。 \\
MC-19 & 依赖管理 & 对“依赖管理”设置明确检查方式，发现问题后由整合者修复或协调相关同学补齐。 & 检查清单、提交记录或最终文档。 \\
MC-20 & 运行环境 & 对“运行环境”设置明确检查方式，发现问题后由整合者修复或协调相关同学补齐。 & 检查清单、提交记录或最终文档。 \\
MC-21 & 演示准备 & 对“演示准备”设置明确检查方式，发现问题后由整合者修复或协调相关同学补齐。 & 检查清单、提交记录或最终文档。 \\
MC-22 & PPT 协同 & 对“PPT 协同”设置明确检查方式，发现问题后由整合者修复或协调相关同学补齐。 & 检查清单、提交记录或最终文档。 \\
MC-23 & 视频协同 & 对“视频协同”设置明确检查方式，发现问题后由整合者修复或协调相关同学补齐。 & 检查清单、提交记录或最终文档。 \\
MC-24 & 最终打包 & 对“最终打包”设置明确检查方式，发现问题后由整合者修复或协调相关同学补齐。 & 检查清单、提交记录或最终文档。 \\
MC-25 & 密钥排查 & 对“密钥排查”设置明确检查方式，发现问题后由整合者修复或协调相关同学补齐。 & 检查清单、提交记录或最终文档。 \\
MC-26 & PDF 检查 & 对“PDF 检查”设置明确检查方式，发现问题后由整合者修复或协调相关同学补齐。 & 检查清单、提交记录或最终文档。 \\
MC-27 & 图表检查 & 对“图表检查”设置明确检查方式，发现问题后由整合者修复或协调相关同学补齐。 & 检查清单、提交记录或最终文档。 \\
MC-28 & 表格检查 & 对“表格检查”设置明确检查方式，发现问题后由整合者修复或协调相关同学补齐。 & 检查清单、提交记录或最终文档。 \\
MC-29 & README 检查 & 对“README 检查”设置明确检查方式，发现问题后由整合者修复或协调相关同学补齐。 & 检查清单、提交记录或最终文档。 \\
MC-30 & 部署检查 & 对“部署检查”设置明确检查方式，发现问题后由整合者修复或协调相关同学补齐。 & 检查清单、提交记录或最终文档。 \\
MC-31 & 验收路径 & 对“验收路径”设置明确检查方式，发现问题后由整合者修复或协调相关同学补齐。 & 检查清单、提交记录或最终文档。 \\
MC-32 & 问题记录 & 对“问题记录”设置明确检查方式，发现问题后由整合者修复或协调相关同学补齐。 & 检查清单、提交记录或最终文档。 \\
MC-33 & 纠偏动作 & 对“纠偏动作”设置明确检查方式，发现问题后由整合者修复或协调相关同学补齐。 & 检查清单、提交记录或最终文档。 \\
MC-34 & 经验总结 & 对“经验总结”设置明确检查方式，发现问题后由整合者修复或协调相关同学补齐。 & 检查清单、提交记录或最终文档。 \\
MC-35 & 后续维护 & 对“后续维护”设置明确检查方式，发现问题后由整合者修复或协调相关同学补齐。 & 检查清单、提交记录或最终文档。 \\
\bottomrule
\end{longtable}
...
\midrule
\endhead
PE-01 & 第一次任务说明 & “第一次任务说明”用于支撑软件工程管理过程，能够说明项目从任务分解到最终提交的演进路径。 & 仓库文档或提交材料目录。 \\
PE-02 & 第二次任务说明 & “第二次任务说明”用于支撑软件工程管理过程，能够说明项目从任务分解到最终提交的演进路径。 & 仓库文档或提交材料目录。 \\
PE-03 & 整合说明 & “整合说明”用于支撑软件工程管理过程，能够说明项目从任务分解到最终提交的演进路径。 & 仓库文档或提交材料目录。 \\
PE-04 & 接口契约 & “接口契约”用于支撑软件工程管理过程，能够说明项目从任务分解到最终提交的演进路径。 & 仓库文档或提交材料目录。 \\
PE-05 & 数据字典 & “数据字典”用于支撑软件工程管理过程，能够说明项目从任务分解到最终提交的演进路径。 & 仓库文档或提交材料目录。 \\
PE-06 & 测试计划 & “测试计划”用于支撑软件工程管理过程，能够说明项目从任务分解到最终提交的演进路径。 & 仓库文档或提交材料目录。 \\
PE-07 & 验收报告 & “验收报告”用于支撑软件工程管理过程，能够说明项目从任务分解到最终提交的演进路径。 & 仓库文档或提交材料目录。 \\
PE-08 & 运行脚本 & “运行脚本”用于支撑软件工程管理过程，能够说明项目从任务分解到最终提交的演进路径。 & 仓库文档或提交材料目录。 \\
PE-09 & 环境示例 & “环境示例”用于支撑软件工程管理过程，能够说明项目从任务分解到最终提交的演进路径。 & 仓库文档或提交材料目录。 \\
PE-10 & Git 忽略规则 & “Git 忽略规则”用于支撑软件工程管理过程，能够说明项目从任务分解到最终提交的演进路径。 & 仓库文档或提交材料目录。 \\
PE-11 & 安全检查 & “安全检查”用于支撑软件工程管理过程，能够说明项目从任务分解到最终提交的演进路径。 & 仓库文档或提交材料目录。 \\
PE-12 & 构建日志 & “构建日志”用于支撑软件工程管理过程，能够说明项目从任务分解到最终提交的演进路径。 & 仓库文档或提交材料目录。 \\
PE-13 & 测试日志 & “测试日志”用于支撑软件工程管理过程，能够说明项目从任务分解到最终提交的演进路径。 & 仓库文档或提交材料目录。 \\
PE-14 & 正式 PDF & “正式 PDF”用于支撑软件工程管理过程，能够说明项目从任务分解到最终提交的演进路径。 & 仓库文档或提交材料目录。 \\
PE-15 & LaTeX 源文件 & “LaTeX 源文件”用于支撑软件工程管理过程，能够说明项目从任务分解到最终提交的演进路径。 & 仓库文档或提交材料目录。 \\
PE-16 & 最终提交说明 & “最终提交说明”用于支撑软件工程管理过程，能够说明项目从任务分解到最终提交的演进路径。 & 仓库文档或提交材料目录。 \\
PE-17 & 演示脚本 & “演示脚本”用于支撑软件工程管理过程，能够说明项目从任务分解到最终提交的演进路径。 & 仓库文档或提交材料目录。 \\
PE-18 & PPT 准备 & “PPT 准备”用于支撑软件工程管理过程，能够说明项目从任务分解到最终提交的演进路径。 & 仓库文档或提交材料目录。 \\
PE-19 & 视频准备 & “视频准备”用于支撑软件工程管理过程，能够说明项目从任务分解到最终提交的演进路径。 & 仓库文档或提交材料目录。 \\
PE-20 & 提交目录 & “提交目录”用于支撑软件工程管理过程，能够说明项目从任务分解到最终提交的演进路径。 & 仓库文档或提交材料目录。 \\
PE-21 & 源码副本 & “源码副本”用于支撑软件工程管理过程，能够说明项目从任务分解到最终提交的演进路径。 & 仓库文档或提交材料目录。 \\
PE-22 & Markdown 过程资料 & “Markdown 过程资料”用于支撑软件工程管理过程，能够说明项目从任务分解到最终提交的演进路径。 & 仓库文档或提交材料目录。 \\
PE-23 & 外部数据调研 & “外部数据调研”用于支撑软件工程管理过程，能够说明项目从任务分解到最终提交的演进路径。 & 仓库文档或提交材料目录。 \\
PE-24 & 大模型接入说明 & “大模型接入说明”用于支撑软件工程管理过程，能够说明项目从任务分解到最终提交的演进路径。 & 仓库文档或提交材料目录。 \\
PE-25 & MCP 说明 & “MCP 说明”用于支撑软件工程管理过程，能够说明项目从任务分解到最终提交的演进路径。 & 仓库文档或提交材料目录。 \\
PE-26 & 最终 README & “最终 README”用于支撑软件工程管理过程，能够说明项目从任务分解到最终提交的演进路径。 & 仓库文档或提交材料目录。 \\
PE-27 & 风险登记册 & “风险登记册”用于支撑软件工程管理过程，能够说明项目从任务分解到最终提交的演进路径。 & 仓库文档或提交材料目录。 \\
PE-28 & 质量矩阵 & “质量矩阵”用于支撑软件工程管理过程，能够说明项目从任务分解到最终提交的演进路径。 & 仓库文档或提交材料目录。 \\
PE-29 & 变更控制 & “变更控制”用于支撑软件工程管理过程，能够说明项目从任务分解到最终提交的演进路径。 & 仓库文档或提交材料目录。 \\
PE-30 & 维护建议 & “维护建议”用于支撑软件工程管理过程，能够说明项目从任务分解到最终提交的演进路径。 & 仓库文档或提交材料目录。 \\
\bottomrule
\end{longtable}
