...
| 模块 | 内容 |
|---|---|
| 客户细分 | 高校后勤能源管理部门、园区物业与能源运维团队、公共建筑管理单位、需要节能监管和运维闭环的楼宇运营方 |
| 价值主张 | 将分散能耗数据转化为可解释的异常、损失、优先级、工单、预算影响和 ROI 决策；用 AI 问答和 MCP 能力降低查询、报告和运维沟通成本 |
| 渠道 | 校园试点部署、园区私有化部署、课程成果展示、后续科研或创新项目申报、运维系统集成合作 |
| 客户关系 | 试点共创、按建筑/设备持续复核收益、月度运行报告、规则与知识库维护、用户培训和验收支持 |
| 收入流 | 试点部署费、年度维护费、按建筑数量或数据规模计费的订阅费、AI 问答增强包、ROI 改造评估服务、私有化定制服务 |
| 核心资源 | 能耗样例数据、数据字典、异常分析规则、工单状态机、ROI 方法学、领域知识库、RAG 素材、MCP Server、前后端可复用代码和测试资产 |
| 关键活动 | 数据治理、异常识别、角色化派单、沙盘模拟、预算 KPI 分析、ROI 改造评价、知识库维护、模型调用控制、系统集成和验收测试 |
| 关键合作 | 高校后勤部门、物业运维团队、云资源提供方、大模型 API 服务方、设备和楼控系统供应商、课程或实验室支持方 |
| 成本结构 | 软件研发成本、人力维护成本、服务器和数据库成本、外部 LLM API 成本、数据清洗与知识库更新成本、试点培训与部署成本、未来硬件和接口集成成本 |
