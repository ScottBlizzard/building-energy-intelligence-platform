...
> 正式提交版已经按课程 LaTeX 模板重写并编译为 PDF。评审和最终提交请优先使用 `docs/final-latex/pdf/03-SEE-软件经济分析与评价.pdf`，LaTeX 源文件见 `docs/final-latex/tex/03-SEE-软件经济分析与评价.tex`。本文档保留为过程版本和快速查阅入口。
