...
\midrule
\endhead
UT-01 & 环境准备 & 按照用户手册完成“环境准备”相关操作，遇到失败时先检查终端输出和常见问题表。 & 能够向他人复述操作目的和结果。 \\
UT-02 & 复制环境变量 & 按照用户手册完成“复制环境变量”相关操作，遇到失败时先检查终端输出和常见问题表。 & 能够向他人复述操作目的和结果。 \\
UT-03 & 安装后端依赖 & 按照用户手册完成“安装后端依赖”相关操作，遇到失败时先检查终端输出和常见问题表。 & 能够向他人复述操作目的和结果。 \\
UT-04 & 安装前端依赖 & 按照用户手册完成“安装前端依赖”相关操作，遇到失败时先检查终端输出和常见问题表。 & 能够向他人复述操作目的和结果。 \\
UT-05 & 启动后端 & 按照用户手册完成“启动后端”相关操作，遇到失败时先检查终端输出和常见问题表。 & 能够向他人复述操作目的和结果。 \\
UT-06 & 启动前端 & 按照用户手册完成“启动前端”相关操作，遇到失败时先检查终端输出和常见问题表。 & 能够向他人复述操作目的和结果。 \\
UT-07 & 打开总览 & 按照用户手册完成“打开总览”相关操作，遇到失败时先检查终端输出和常见问题表。 & 能够向他人复述操作目的和结果。 \\
UT-08 & 理解 KPI & 按照用户手册完成“理解 KPI”相关操作，遇到失败时先检查终端输出和常见问题表。 & 能够向他人复述操作目的和结果。 \\
UT-09 & 旋转楼宇 & 按照用户手册完成“旋转楼宇”相关操作，遇到失败时先检查终端输出和常见问题表。 & 能够向他人复述操作目的和结果。 \\
UT-10 & 点击楼层 & 按照用户手册完成“点击楼层”相关操作，遇到失败时先检查终端输出和常见问题表。 & 能够向他人复述操作目的和结果。 \\
UT-11 & 查询记录 & 按照用户手册完成“查询记录”相关操作，遇到失败时先检查终端输出和常见问题表。 & 能够向他人复述操作目的和结果。 \\
UT-12 & 筛选楼层 & 按照用户手册完成“筛选楼层”相关操作，遇到失败时先检查终端输出和常见问题表。 & 能够向他人复述操作目的和结果。 \\
UT-13 & 导出 CSV & 按照用户手册完成“导出 CSV”相关操作，遇到失败时先检查终端输出和常见问题表。 & 能够向他人复述操作目的和结果。 \\
UT-14 & 查看趋势 & 按照用户手册完成“查看趋势”相关操作，遇到失败时先检查终端输出和常见问题表。 & 能够向他人复述操作目的和结果。 \\
UT-15 & 查看异常 & 按照用户手册完成“查看异常”相关操作，遇到失败时先检查终端输出和常见问题表。 & 能够向他人复述操作目的和结果。 \\
UT-16 & 查看解释 & 按照用户手册完成“查看解释”相关操作，遇到失败时先检查终端输出和常见问题表。 & 能够向他人复述操作目的和结果。 \\
UT-17 & 查看设备 & 按照用户手册完成“查看设备”相关操作，遇到失败时先检查终端输出和常见问题表。 & 能够向他人复述操作目的和结果。 \\
UT-18 & 创建工单 & 按照用户手册完成“创建工单”相关操作，遇到失败时先检查终端输出和常见问题表。 & 能够向他人复述操作目的和结果。 \\
UT-19 & 完成工单 & 按照用户手册完成“完成工单”相关操作，遇到失败时先检查终端输出和常见问题表。 & 能够向他人复述操作目的和结果。 \\
UT-20 & 刷新验证 & 按照用户手册完成“刷新验证”相关操作，遇到失败时先检查终端输出和常见问题表。 & 能够向他人复述操作目的和结果。 \\
UT-21 & 查看日报 & 按照用户手册完成“查看日报”相关操作，遇到失败时先检查终端输出和常见问题表。 & 能够向他人复述操作目的和结果。 \\
UT-22 & 提出问题 & 按照用户手册完成“提出问题”相关操作，遇到失败时先检查终端输出和常见问题表。 & 能够向他人复述操作目的和结果。 \\
UT-23 & 选择模型 & 按照用户手册完成“选择模型”相关操作，遇到失败时先检查终端输出和常见问题表。 & 能够向他人复述操作目的和结果。 \\
UT-24 & 理解回退 & 按照用户手册完成“理解回退”相关操作，遇到失败时先检查终端输出和常见问题表。 & 能够向他人复述操作目的和结果。 \\
UT-25 & 启动 MCP & 按照用户手册完成“启动 MCP”相关操作，遇到失败时先检查终端输出和常见问题表。 & 能够向他人复述操作目的和结果。 \\
UT-26 & 查看 API 文档 & 按照用户手册完成“查看 API 文档”相关操作，遇到失败时先检查终端输出和常见问题表。 & 能够向他人复述操作目的和结果。 \\
UT-27 & 运行测试 & 按照用户手册完成“运行测试”相关操作，遇到失败时先检查终端输出和常见问题表。 & 能够向他人复述操作目的和结果。 \\
UT-28 & 编译文档 & 按照用户手册完成“编译文档”相关操作，遇到失败时先检查终端输出和常见问题表。 & 能够向他人复述操作目的和结果。 \\
UT-29 & 检查密钥 & 按照用户手册完成“检查密钥”相关操作，遇到失败时先检查终端输出和常见问题表。 & 能够向他人复述操作目的和结果。 \\
UT-30 & 整理提交包 & 按照用户手册完成“整理提交包”相关操作，遇到失败时先检查终端输出和常见问题表。 & 能够向他人复述操作目的和结果。 \\
UT-31 & 打开正式 PDF & 按照用户手册完成“打开正式 PDF”相关操作，遇到失败时先检查终端输出和常见问题表。 & 能够向他人复述操作目的和结果。 \\
UT-32 & 准备 PPT & 按照用户手册完成“准备 PPT”相关操作，遇到失败时先检查终端输出和常见问题表。 & 能够向他人复述操作目的和结果。 \\
UT-33 & 录制视频 & 按照用户手册完成“录制视频”相关操作，遇到失败时先检查终端输出和常见问题表。 & 能够向他人复述操作目的和结果。 \\
UT-34 & 答辩演示 & 按照用户手册完成“答辩演示”相关操作，遇到失败时先检查终端输出和常见问题表。 & 能够向他人复述操作目的和结果。 \\
UT-35 & 故障排查 & 按照用户手册完成“故障排查”相关操作，遇到失败时先检查终端输出和常见问题表。 & 能够向他人复述操作目的和结果。 \\
\bottomrule
\end{longtable}
